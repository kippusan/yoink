...
pub(crate) const QUALITY_WARNING: &str =
    "Default quality is LOSSLESS (CD, 16-bit/44.1kHz FLAC). Set DEFAULT_QUALITY=HI_RES_LOSSLESS for 24-bit hi-res if available.";
